...
const Contact = () => {
  ...
  return (
    <div className="p-6 md:p-12 mt-10 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" id="contact">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-2">Get in Touch</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-6">Have a question? Feel free to reach out.</p>
      </div>

      {/* Flex container for side-by-side layout */}
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10">
        {/* Contact Form */}
        <div className="w-full md:w-1/2 shadow-lg rounded-lg p-6 md:p-10 bg-white dark:bg-gray-800">
          <form className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400"
              />
            </div>
            ...
            <button
              type="submit"
              className="bg-pink-600 text-white px-6 py-2 rounded hover:bg-pink-400 transition"
            >
              Send Message
            </button>
          </form>
